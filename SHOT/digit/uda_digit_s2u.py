...
from digit.data_loader import GetLoader,GetLoader_idx
...
def digit_load(args): 
    ...
    if args.dset == 's2m':
        ...
        target_image_root = os.path.join('data', target_dataset_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dset', type=str, default='s2u', choices=['u2m', 'm2u','s2m','m2mm','s2u'])
